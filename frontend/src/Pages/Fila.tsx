...
//         { id: 'age', label: 'Idade', minWidth: 60, align: 'center' },
//         { id: 'sex', label: 'Sexo', minWidth: 60, align: 'center' }
//     ];
//
//     function createData(name: any, age: any, sex: any): Data {
//         return { name, age, sex };
//     }
//
//     const rows = [
//         createData('Andre Vasconcelos', '21', 'M', 'andre69'),
//         createData('Andre Vasconcelos', '21', 'M', 'andre69'),
//         createData('Andre Vasconcelos', '21', 'M', 'andre69'),
//         createData('Andre Vasconcelos', '21', 'M', 'andre69'),
//         createData('Andre Vasconcelos', '21', 'M', 'andre69'),
